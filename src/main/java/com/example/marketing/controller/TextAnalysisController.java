...
public class TextAnalysisController {
    ...
    @PostMapping
    public ResponseEntity<TextAnalysisResponseDTO> createTextAnalysis(@Valid @RequestBody TextAnalysisRequestDTO requestDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TextAnalysisResponseDTO> updateTextAnalysis(@PathVariable Integer id, @Valid @RequestBody TextAnalysisRequestDTO requestDTO) {
