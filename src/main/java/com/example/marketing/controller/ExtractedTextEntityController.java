...
public class ExtractedTextEntityController {
    ...
    @PostMapping
    public ResponseEntity<ExtractedTextEntityResponseDTO> createEntity(@Valid @RequestBody ExtractedTextEntityRequestDTO requestDTO) {
    ...
    @Operation(summary = "Get all extracted text entities")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "List of entities")
    })
    @GetMapping
    public ResponseEntity<List<ExtractedTextEntityResponseDTO>> getAllEntities() {
        List<ExtractedTextEntityResponseDTO> entities = extractedTextEntityService.findAll();
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ExtractedTextEntityResponseDTO> updateEntity(@PathVariable Integer id, @Valid @RequestBody ExtractedTextEntityRequestDTO requestDTO) {
    ...
    public ResponseEntity<List<ExtractedTextEntityResponseDTO>> getEntitiesByAnalysisId(@PathVariable Integer analysisId) {
    ...
    public ResponseEntity<List<ExtractedTextEntityResponseDTO>> getEntitiesByEntityType(@PathVariable String entityType) {
